                ...
                <div class="row">
                    <div class="col-xl-10 m-auto">
                        <div class="card mb-4 shadow">
                            <div class="card-header bg-primary text-white">Update User Profile</div>
                            <div class="card-body">
                            <form action="update_user_profile.php?id=<?= $id; ?>" method="POST">
                                <!-- Name -->
                                <div class="mb-3">
                                    <label for="name" class="small mb-1">Name</label>
                                    <input name="name" id="name" type="text" value="<?= $name; ?>" class="form-control" placeholder="Enter your name" required />
                                </div>

                                <!-- Email -->
                                <div class="mb-3">
                                    <label for="email" class="small mb-1">Email</label>
                                    <input name="email" id="email" type="email" value="<?= $email; ?>" class="form-control" placeholder="Enter your email" required />
                                </div>

                                <!-- Password -->
                                <div class="mb-3">
                                    <label for="password" class="small mb-1">Password</label>
                                    <input name="password" id="password" type="password" value="<?= $password; ?>" class="form-control" placeholder="Enter your password" required />
                                </div>
                                <div class="row gx-3">
                                <!-- Age -->
                                <div class="col-md-6 mb-3">
                                    <label for="age" class="small mb-1">Age</label>
                                    <input name="age" id="age" type="number" min="0" value="<?= $age; ?>" class="form-control" placeholder="Enter your age" required />
                                </div>
                                ...
                                <!-- Height -->
                                <div class="col-md-6 mb-3">
                                    <label for="height" class="small mb-1">Height</label>
                                    <input name="height" id="height" type="number" min="0" value="<?= $height; ?>" class="form-control" placeholder="Enter your height" required />
                                </div>

                                <!-- Weight -->
                                <div class="col-md-6 mb-3">
                                    <label for="weight" class="small mb-1">Weight</label>
                                    <input name="weight" id="weight" type="number" min="0" value="<?= $weight; ?>" class="form-control" placeholder="Enter your weight" required />
                                </div>
                                </div>
