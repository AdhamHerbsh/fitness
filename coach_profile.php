            ...
            <div class="row">
                <div class="col-xl-10 m-auto">
                    <div class="card mb-4 shadow">
                        ...
                        <div class="card-body">
                        <form action="coach_profile.php" method="POST">
                                <!-- Name -->
                                <div class="mb-3">
                                ...
                                <!-- Email -->
                                <div class="mb-3">
                                    <label for="name" class="small mb-1">Email</label>
                                    <input name="email" type="email" value="<?= $email; ?>" class="form-control" placeholder="Enter email" required />
                                </div>
                                <!-- Password -->
                                <div class="mb-3">
                                    <label for="password" class="small mb-1">Password</label>
                                    <input name="password" type="password" value="<?= $password; ?>" class="form-control" placeholder="Enter password" required />
                                </div>
                                <!-- Age -->
                                <div class="mb-3">
                                    <label for="number" class="small mb-1">Age</label>
                                    <input name="age" type="number" min="0" value="<?= $age; ?>" class="form-control" placeholder="Enter age" required />
                                </div>
                                <!-- Gender -->
                                <div class="mb-3">
