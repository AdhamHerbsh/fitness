...
include("conn.php");
$id = $_SESSION['id'];
$sql = "SELECT * FROM workout_plans WHERE coach_id = $id";
        ...
        <div class="container-fluid p-5 table-responsive">
            ...
            <table style="background: #222429;color:white ;width: 100%;text-align: center;direction: ltr;" class="table">
                <tr>
                    ...
                    <th>
                        <a href="add_plan.php">
                            <i class="fa fa-plus-circle" style="color:#FB5B21">
                            </i>
                        </a>
                    </th>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="pdf_file.php?id=<?= $row['id']; ?>">show</a>
                        </td>
                        <td>
                            <a class="btn btn-secondary" href="./update_plan.php?id=<?= $row['id']; ?>">update</a>
                        </td>
                        <td>
                        <a class="btn btn-danger" href="./plan-delete.php?id=<?= $row['id']; ?>">delete</a>
                        </td>
                    </tr>
                <?php
                }
